...
- [ ] Build the site.
	...
	- [ ] Functionality to address
		...
		- [ ] The content under the `Message` section in the email generated by the contact form is not formatted at all. In particular, the string is all in one line even when the message body in the contact form is written across several lines.
