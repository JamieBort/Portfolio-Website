...
const SkillsList = styled.div`
  ...
  // flex: 1;  // From Original before it was converted to flexbox from grid. NOTE: this is being address in this https://github.com/JamieBort/Portfolio-Website/issues/51 Issue.
  width: 100%;
`;
